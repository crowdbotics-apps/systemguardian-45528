"""
Django settings for systemguardian_45528 project.
...
ROOT_URLCONF = 'systemguardian_45528.urls'
...
WSGI_APPLICATION = 'systemguardian_45528.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "systemguardian_45528 API",
    "DESCRIPTION": "API documentation for systemguardian_45528 App",
    "VERSION": "v1",
}
